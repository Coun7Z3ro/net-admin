...
![Обновление конфигурации GRUB2](image/2.png){ #fig:002 width=70% }

Перезагружаю систему. После перезагрузки появляется меню загрузчика GRUB (см. рис. [@fig:003]).

![Меню загрузчика GRUB](image/3.png){ #fig:003 width=70% }
...
![Добавление параметра rescue.target](image/4.png){ #fig:004 width=70% }
...
![Переменные среды](image/5.png){ #fig:005 width=70% }
...
![Параметр emergency.target](image/6.png){ #fig:006 width=70% }
...
![Минимальный набор загруженных модулей](image/7.png){ #fig:007 width=70% }
...
![Ошибки при попытках выполнения команд](image/8.png){ #fig:008 width=70% }
...
![Запуск системы с init=/bin/bash](image/9.png){ #fig:009 width=70% }
...
![Успешная смена пароля root](image/10.png){ #fig:010 width=70% }
...
![Успешная аутентификация после сброса пароля](image/11.png){ #fig:011 width=70% }
