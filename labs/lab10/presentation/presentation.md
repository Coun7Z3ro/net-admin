...
![Вывод lspci -k](image/01.png){ width=70% }

## Проверка и загрузка модуля ext4

![Загрузка и проверка модуля ext4](image/02.png){ width=70% }

## Информация о модуле ext4

![Информация о модуле ext4](image/03.png){ width=70% }

## Выгрузка модуля

![Выгрузка ext4 и ошибка при удалении xfs](image/04.png){ width=70% }

## Модули с параметрами (Bluetooth)

![Загрузка bluetooth](image/05.png){ width=70% }

## Параметры Bluetooth

![Информация о модуле bluetooth](image/06.png){ width=70% }

## Обновление

![Обновление пакетов и ядра](image/08.png){ width=70% }

## Проверка новой версии ядра

![Проверка версии ядра после перезагрузки](image/09.png){ width=70% }
